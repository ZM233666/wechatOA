...
export async function getNewsCategories(
  ...
  try {
    ...
    const items = [
      ...
      ...(await getNewsCategoriesForRequest()).map((category) => ({
        ...category,
...
export async function getNewsList(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const filtered = listPublicNews(await getNewsArticlesForRequest()).filter((item) => {
...
export async function getNewsDetail(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
